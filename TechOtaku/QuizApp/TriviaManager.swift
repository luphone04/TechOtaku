...
//    }
        ...
        // Asynchronous function to load trivia data from a local JSON file
        func loadTriviaFromLocalFile() async {
            if let url = Bundle.main.url(forResource: "answer", withExtension: "json") {
                do {
                    ...
                    print("Error loading trivia from local file: \(error)")
                }
            } else {
                print("Local JSON file 'answer.json' not found.")
            }
        }
